...
import { Search, Filter, UserPlus, Mail, Phone, Award, FileCheck, ChevronRight, ArrowUpRight, Activity, ShieldCheck, Users } from 'lucide-react';
...
const MOCK_PERSONNEL = [
  {
    ...
    role: '一级建造师',
    department: '工程部',
    certificates: ['一级建造师（建筑工程）', '高级工程师'],
    status: '在岗',
    experience: '15年',
    email: 'chen.jg@company.com',
    phone: '138****8888',
  },
  {
    id: '2',
    ...
    role: '造价工程师',
    department: '商务部',
    certificates: ['一级造价工程师', '中级会计师'],
    status: '在岗',
    experience: '8年',
    email: 'lin.j@company.com',
    phone: '139****9999',
  },
  {
    id: '3',
    ...
    role: '项目经理',
    department: '工程部',
    certificates: ['一级建造师（市政公用）', '安全生产考核合格证（B证）'],
    status: '出差',
    experience: '12年',
    email: 'wang.zw@company.com',
    phone: '137****7777',
  },
  {
    id: '4',
    ...
    role: '技术负责人',
    department: '技术部',
    certificates: ['高级工程师', '注册结构工程师'],
    status: '在岗',
    experience: '20年',
    email: 'li.xf@company.com',
    phone: '136****6666',
  },
];
    ...
    <div className="max-w-6xl mx-auto space-y-12 pb-20">
      ...
      <div className="grid grid-cols-4 gap-8">
        <div className="bg-white border border-slate-200 p-6 flex flex-col justify-between group hover:border-slate-900 transition-colors">
          ...
          <div className="text-3xl font-bold tracking-tighter text-slate-900">42</div>
        ...
        <div className="bg-white border border-slate-200 p-6 flex flex-col justify-between group hover:border-slate-900 transition-colors">
          ...
          <div className="text-3xl font-bold tracking-tighter text-slate-900">156</div>
      ...
      <div className="grid grid-cols-2 gap-8">
        {MOCK_PERSONNEL.map((person) => (
          <div key={person.id} className="bg-white border border-slate-200 p-6 flex flex-col hover:border-slate-900 hover:shadow-2xl transition-all group relative overflow-hidden">
